import { SUPPORT_CURRENCIES } from "@/lib/constant";
...
export const CurrencySelect = ({
  ...
  return (
    ...
    >
      {children}
      {active && (
        <div className="absolute z-20 w-48 py-2 mt-2 origin-bottom-left top-[50px] right-[160px] bg-white rounded-md shadow-xl dark:bg-gray-800">
