import { SUPPORT_NETWORKS } from "@/utils/constant";
...
export const NetworkSelect = ({ active, setActive, children, chainId, setChainId }: NetworkSelectProps) => {
  return (
    <div className="relative inline-block" onMouseLeave={() => setActive(false)}>
      {children}
      {
        active &&
          <div
              className="absolute z-20 w-48 py-2 mt-2 origin-bottom-left top-[-40px] right-[55px] bg-white rounded-md shadow-xl dark:bg-gray-800"
          >
            {
